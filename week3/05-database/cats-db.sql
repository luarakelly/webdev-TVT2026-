...
('Example User', 'exampleuser', 'example@metropolia.fi', 'user', 'password'),
('Test User', 'testuser', 'test@metropolia.fi', 'admin', 'password');
...
ALTER TABLE wsk_cats MODIFY cat_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY;
